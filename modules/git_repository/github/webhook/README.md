...
| <a name="input_events"></a> [events](#input\_events) | List of events which trigger the webhook | `list(string)` | <pre>[<br>  "issue_comment",<br>  "pull_request",<br>  "pull_request_review",<br>  "pull_request_review_comment"<br>]</pre> | no |
